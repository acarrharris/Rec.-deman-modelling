...
param_draws_MA$state<-"MA"
param_draws_RI$state<-"RI"
param_draws_CT$state<-"CT"
param_draws_NY$state<-"NY"
param_draws_NJ$state<-"NJ"
param_draws_DE$state<-"DE"
param_draws_MD$state<-"MD"
param_draws_VA$state<-"VA"
param_draws_NC$state<-"NC"


param_draws_all = dplyr::bind_rows(param_draws_MA, param_draws_RI,param_draws_CT,param_draws_NY,param_draws_NJ,
                               param_draws_DE, param_draws_MD, param_draws_VA, param_draws_NC)
param_draws_all_base <- split(param_draws_all, param_draws_all$state)
