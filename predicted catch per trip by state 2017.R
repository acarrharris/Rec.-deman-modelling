...
# summary(nbfit_sf)
nbfit_sf <- readRDS("nb_catch_parameters_sf_NO_17.rds")
...
nbfit_bsb <- readRDS("nb_catch_parameters_bsb_NO_17.rds")
...
fit <- readRDS("catch_copula_NO_17.rds")
...
nbfit_sf <- readRDS("nb_catch_parameters_sf_NJ_17.rds")
...
nbfit_bsb <- readRDS("nb_catch_parameters_bsb_NJ_17.rds")
...
fit <- readRDS("catch_copula_NJ_17.rds")
...
nbfit_sf <- readRDS("nb_catch_parameters_sf_SO_17.rds")
...
# nbfit_bsb <- fitdistr(bsb, "Negative Binomial")
# nbfit_bsb
nbfit_bsb <- readRDS("nb_catch_parameters_bsb_SO_17.rds")
...
fit <- readRDS("catch_copula_SO_17.rds")
