...
for(p in levels(periodz)){
  ...
  for(i in 1:10) {
    ...
    if(fluke_bag>0){
      ...
      sf_catch_data1$keep = ifelse(sf_catch_data1$uniform>=0.5, 1,0) 
    ...
    if(bsb_bag>0){
      ...
      bsb_catch_data1$keep = ifelse(bsb_catch_data1$uniform>=.99, 1,0) 
    ...
    if(wf_bag>0){
      ...
      wf_catch_data1$keep = ifelse(wf_catch_data1$uniform>=.8, 1,0)
...
utilites_NC_all=list.stack(utilites_NC, fill=TRUE)
...
((91192.57-sum(pds_new_all_NC$tot_keep))/91192.57)*100

sum(pds_new_all_NC$tot_rel)
((1334.247-sum(pds_new_all_NC$tot_rel))/1334.247)*100


pds_new_all_NC$tot_sf_cat=pds_new_all_NC$tot_keep+pds_new_all_NC$tot_rel
sum(pds_new_all_NC$tot_sf_cat)
(((91192.57+1334.247)-sum(pds_new_all_NC$tot_sf_cat))/(91192.57+1334.247))*100



sum(pds_new_all_NC$tot_keep_bsb)
((414.0845-sum(pds_new_all_NC$tot_keep_bsb))/414.0845)*100

sum(pds_new_all_NC$tot_rel_bsb)
((55986.65 -sum(pds_new_all_NC$tot_rel_bsb))/55986.65 )*100

pds_new_all_NC$tot_bsb_cat=pds_new_all_NC$tot_keep_bsb+pds_new_all_NC$tot_rel_bsb
sum(pds_new_all_NC$tot_bsb_cat)
(((414.0845+55986.65)-sum(pds_new_all_NC$tot_bsb_cat))/(414.0845+55986.65))*100




sum(pds_new_all_NC$tot_keep_wf)
(( 855.261-sum(pds_new_all_NC$tot_keep_wf))/ 855.261)*100

sum(pds_new_all_NC$tot_rel_wf)
((1983.389-sum(pds_new_all_NC$tot_rel_wf))/1983.389)*100

pds_new_all_NC$tot_wf_cat=pds_new_all_NC$tot_keep_wf+pds_new_all_NC$tot_rel_wf
sum(pds_new_all_NC$tot_wf_cat)
(((855.261+1983.389)-sum(pds_new_all_NC$tot_wf_cat))/(855.261+1983.389))*100



sum(pds_new_all_NC$tot_keep_rd)
((27555.07-sum(pds_new_all_NC$tot_keep_rd))/27555.07)*100

sum(pds_new_all_NC$tot_rel_rd)
((35181.63-sum(pds_new_all_NC$tot_rel_rd))/35181.63)*100

pds_new_all_NC$tot_rd_cat=pds_new_all_NC$tot_keep_rd+pds_new_all_NC$tot_rel_rd
sum(pds_new_all_NC$tot_rd_cat)
(((27555.07+35181.63)-sum(pds_new_all_NC$tot_rd_cat))/(27555.07+35181.63))*100
