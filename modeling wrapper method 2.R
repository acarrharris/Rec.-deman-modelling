...
for (x in 1:1){
  ...
  source("prediction 4a - MA.R")
  source("prediction 4a - RI.R")
  source("prediction 4a - CT.R")
  source("prediction 4a - NY.R")
  source("prediction 4a - NJ.R")
  source("prediction 4a - DE.R")
  source("prediction 4a - MD.R")
  source("prediction 4a - VA.R")
  source("prediction 4a - NC.R")
