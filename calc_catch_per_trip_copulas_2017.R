...
###Northern states
catch_data <- read_excel("observed_catch_NO_17.xlsx")
...
saveRDS(nbfit_sf, "nb_catch_parameters_sf_NO_17.rds")
...
saveRDS(nbfit_bsb, "nb_catch_parameters_bsb_NO_17.rds")
...
saveRDS(fit, "catch_copula_NO_17.rds")
...
write_xlsx(catch_data_sim, "NO_catch_data_sim1_2017.xlsx") 
...
###New Jersey
catch_data <- read_excel("observed_catch_NJ_17.xlsx")
...
#estimate the nb parameters
nbfit_sf = fitdistr(sf, "Negative Binomial")
saveRDS(nbfit_sf, "nb_catch_parameters_sf_NJ_17.rds")
...
nbfit_bsb <- fitdistr(bsb, "Negative Binomial")
saveRDS(nbfit_bsb, "nb_catch_parameters_bsb_NJ_17.rds")
...
saveRDS(fit, "catch_copula_NJ_17.rds")
...
write_xlsx(catch_data_sim, "NJ_catch_data_sim1_2017.xlsx") 


###Southern states
catch_data <- read_excel("observed_catch_SO_17.xlsx")
...
#estimate the nb parameters
nbfit_sf = fitdistr(sf, "Negative Binomial")
saveRDS(nbfit_sf, "nb_catch_parameters_sf_SO_17.rds")
...
nbfit_bsb <- fitdistr(bsb, "Negative Binomial")
saveRDS(nbfit_bsb, "nb_catch_parameters_bsb_SO_17.rds")
...
saveRDS(fit, "catch_copula_SO_17.rds")
...
write_xlsx(catch_data_sim, "SO_catch_data_sim1_2017.xlsx") 
